...
const translations: Record<Language, Record<string, string>> = {
  ja: {
    ...
    "subcat.test": "テスト商品",
    "subcat.etc": "その他",
    "home.collection": "mignonの特別なコレクション",
    "home.noProducts": "登録された商品がありません",
    "home.freeShipping": "送料無料",
    "home.freeShippingDesc": "EMS国際配送 10万ウォン以上で送料無料",
    "home.quality": "品質保証",
    "home.qualityDesc": "1年間無料A/S",
    "home.gift": "ギフトラッピング",
    "home.giftDesc": "無料ギフトラッピング",
    "banner.newArrival": "mignonの新しいコレクションをご覧ください",
    ...
    "product.deliveryInfo": "EMS国際配送 10万ウォン以上で送料無料 | 平日14時までのご注文で当日発送",
    ...
    "order.lineHint": "(LINE ID ❌)",
    "order.linePlaceholder": "LINE NAMEを入力してください",
    "order.lineNotice": "ご注文後、必ずLINEで注文したとお知らせください。",
    "order.phone": "電話番号 (EMS発送時に必要)",
    "order.phonePlaceholder": "090-1234-5678",
    "order.memo": "ご要望 (任意)",
    "order.memoPlaceholder": "配送・ラッピングのご要望など",
    "order.notice": "※ ご注文確定後、必ずLINEでご連絡お願いいたします。",
    ...
    "order.requiredError": "必須項目をすべて入力してください。",
    "order.nameRequired": "お名前を入力してください。",
    "order.lineRequired": "LINE NAMEを入力してください。",
    "order.phoneRequired": "電話番号を入力してください。",
    "footer.about": "会社概要",
    "footer.contact": "お問い合わせ",
    "footer.privacy": "プライバシーポリシー",
    "footer.terms": "利用規約",
    "footer.copyright": "© 2026 mignon. All rights reserved.",
  ...
  ko: {
    ...
    "order.line": "LINE NAME",
    "order.lineHint": "(LINE ID ❌)",
    "order.linePlaceholder": "LINE NAME을 입력해주세요",
    "order.lineNotice": "주문 후 반드시 LINE으로 주문했다고 알려주세요.",
    "order.phone": "전화번호 (EMS 발송 시 필요)",
    "order.phonePlaceholder": "090-1234-5678",
    "order.memo": "요청사항 (선택)",
    "order.memoPlaceholder": "배송, 포장 관련 요청사항",
    "order.notice": "※ 주문 확정 후 반드시 LINE으로 연락 부탁드립니다.",
    "order.submit": "주문 확정",
    ...
    "order.requiredError": "필수 항목을 모두 입력해주세요.",
    "order.nameRequired": "이름을 입력해주세요.",
    "order.lineRequired": "LINE NAME을 입력해주세요.",
    "order.phoneRequired": "전화번호를 입력해주세요.",
    "footer.about": "회사 소개",
    "footer.contact": "문의하기",
