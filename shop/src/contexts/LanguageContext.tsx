...
const translations: Record<Language, Record<string, string>> = {
  ja: {
    ...
    "subcat.test": "テスト商品",
    "subcat.etc": "その他",
    "home.collection": "CREAMの特別なコレクション",
    ...
    "banner.newArrival": "CREAMの新しいコレクションをご覧ください",
    ...
    "footer.terms": "利用規約",
    "footer.copyright": "© 2026 CREAM. All rights reserved.",
  ...
  ko: {
    ...
    "subcat.test": "테스트 상품",
    "subcat.etc": "기타",
    "home.collection": "CREAM의 특별한 컬렉션",
    ...
    "banner.newArrival": "CREAM의 새로운 컬렉션을 만나보세요",
