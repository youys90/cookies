        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/?category=목걸이" className="text-gray-500 hover:text-gray-900 text-sm">목걸이</Link></li>
              <li><Link href="/?category=귀걸이" className="text-gray-500 hover:text-gray-900 text-sm">귀걸이</Link></li>
              <li><Link href="/?category=반지" className="text-gray-500 hover:text-gray-900 text-sm">반지</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              <a href="#" className="p-2 -ml-2 text-gray-400 hover:text-gray-600" aria-label="인스타그램">
