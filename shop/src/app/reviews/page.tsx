        ...
        >
          ...
          {lightboxImages.length > 1 && (
            <button
              ...
              className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 bg-black bg-opacity-50 text-white hover:bg-opacity-70 p-2 rounded-full z-10"
            >
          ...
          {lightboxImages.length > 1 && (
            <button
              ...
              className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 bg-black bg-opacity-50 text-white hover:bg-opacity-70 p-2 rounded-full z-10"
            >
              <svg className="w-6 h-6 sm:w-8 sm:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
