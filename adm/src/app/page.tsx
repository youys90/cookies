  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 mt-1">LUMIÈRE 관리자 현황</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          <p className="text-xs text-gray-400 mt-2">품절 1개</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-900 mt-1">{formatPrice(totalRevenue)}</p>
            </div>
          ...
          <p className="text-xs text-gray-400 mt-2">이번 달</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-900 mt-1">{pendingOrders}</p>
            </div>
          ...
          <p className="text-xs text-gray-400 mt-2">처리 필요</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm">
          <div className="p-6 border-b border-gray-100">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-medium text-gray-900">재고 부족</h2>
