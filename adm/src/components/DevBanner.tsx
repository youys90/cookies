...
export default function DevBanner() {
  ...
  return (
    <>
      ...
      {/* 우측 하단 플로팅 배지 (닫기 가능) */}
      {isVisible && (
        <div className="fixed bottom-4 right-4 z-[9999] bg-orange-500 text-white px-4 py-2 rounded-lg shadow-lg flex items-center space-x-3">
          <div className="flex items-center space-x-2">
            <span className="text-lg">🔧</span>
            <div>
              <p className="text-sm font-bold">개발 서버</p>
              <p className="text-xs opacity-80">개발 DB 연결됨</p>
            </div>
          </div>
          <button
